...
const markdownContent = `# Database Management Systems (DBMS)
...
const targetFilePath = path.join(process.cwd(), "public/uploads/sql-basics.md");
...
async function main() {
    ...
    console.log(`Markdown written to: ${targetFilePath}`);
    ...
    if (result.length > 0) {
        ...
        console.log("No matching database records found to update. Inserting a new one...");
