  ...
  const getLinks = () => {
    ...
    if (role === "ADMIN") {
      ...
      return [
        ...
        { href: "/dashboard/teacher/assignments", icon: FileEdit, label: "Create Assignments" },
        { href: "/dashboard/teacher/progress", icon: BarChart, label: "Student Tracker" },
        { href: "/dashboard/teacher/attendance", icon: Calendar, label: "Post Attendance" },
        { href: "/dashboard/teacher/evaluation", icon: CheckSquare, label: "Assignment Grading" },
        { href: "/dashboard/teacher/internals", icon: ClipboardList, label: "Internal Marks" },
        { href: "/dashboard/teacher/endsem", icon: Shield, label: "Sem Evaluation" },
        { href: "/dashboard/community", icon: Users, label: "Community" },
      ];
    } else {
      return [
        ...
        { href: "/dashboard/assignments", icon: FileEdit, label: "Assignment Submission" },
        { href: "/dashboard/attendance", icon: Calendar, label: "Attendance Tracker" },
        { href: "/dashboard/results", icon: Award, label: "Results" },
        { href: "/dashboard/payments", icon: CreditCard, label: "Payments" },
