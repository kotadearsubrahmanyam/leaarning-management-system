        ...
        <div className="bg-white border border-[#E2E8F0] p-5 rounded-2xl shadow-sm mb-6 flex flex-col gap-4">
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            <div className="flex items-center gap-3 md:col-span-2">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-slate-50 border border-[#E2E8F0] text-slate-400">
              ...
              <input
                ...
                className="px-4 pr-4 flex-1 border border-[#E2E8F0] rounded-xl py-3 text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#7C3AED] focus:border-transparent text-sm transition-all bg-slate-50/50"
              />
            </div>
            <div>
              <select
